...
class VerTareasEnCalendarioViewMiembro extends StatefulWidget {
...
class _VerTareasEnCalendarioViewState
    extends State<VerTareasEnCalendarioViewMiembro> {
  ...
  Future<void> _cargarEventos() async {
    ...
    await tareaViewModel.obtenerMisTareas(userViewModel.token!);
