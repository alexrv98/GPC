...
import 'tareas_miembro_view.dart';
import 'VerTareasEnCalendarioViewMiembro.dart';
            ...
            children: <Widget>[
              ...
              _createDrawerItem(
                ...
                onTap: () => _navigateTo(context,
                    HomeViewMiembro(userName: userName, userEmail: userEmail)),
              ),
              _createDrawerItem(
                context,
                icon: Icons.task,
              ...
              _createDrawerItem(
                ...
                onTap: () => _navigateTo(
                    context,
                    VerTareasEnCalendarioViewMiembro(
                        userName: userName, userEmail: userEmail)),
              ),
...
class _TopRoundedClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.lineTo(0, size.height * 0.58); // Corta justo a la mitad del Drawer
    path.quadraticBezierTo(size.width * 0.5, size.height * 0.6, size.width,
        size.height * 0.58); // Curva en las esquinas superiores
